...
<div class="container-fluid carousel_project_container">
  <div class="col-md-12 project_small_block">
    <div class="col-xs-4 col-md-3 small_slider_container">
      ...
      <a id="small_slider_prev" href="#carousel_project" role="button" data-slide="next">
      ...
      <a  id="small_slider_next" class="right carousel-control" href="#carousel_project" role="button" data-slide="prev">
...
<div class="container document_blocks">
      ...
      <div class="col-md-12">
        <div class="col-md-4 doc_container">
          ...
          <a class="document_link rules" target="_blank" href="<?php echo get_theme_file_uri('rules.pdf') ?>"></iframe></a>
          <p class="project_document_title">Правила ТСН </p>
            </div>
        </div>
        <div class="col-md-4 doc_container">
          <div class="document_links_container">
           <a class="document_link ustav" target="_blank" href="<?php echo get_theme_file_uri('ustav.pdf') ?>"></a>
          <p class="project_document_title">Проект Устава ТСН </p>
             </div>
        </div>
        <div class="col-md-4 doc_container">
          <div class="document_links_container">
           <a class="document_link program" target="_blank" href="<?php echo get_theme_file_uri('program.pdf') ?>"></a>
          <p class="project_document_title">Программа благоустройства ТСН </p>
            </div>
        </div>
      </div>
    </div>
...
<script src="<?php echo get_theme_file_uri('js/custom_script.js') ?>"></script>
...
<script>
      $(".variable").slick({
       infinite: true,
        ...
        speed: 1000,
        dots: false,
        nextArrow: $('#small_slider_prev'),
        prevArrow: $('#small_slider_next'),
        autoplay:true,
         autoplaySpeed:5500,
         responsive: [
      {
